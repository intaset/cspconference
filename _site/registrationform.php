...
<div class="unit unit-s-1 unit-m-1-4 unit-l-1-4">
  <div class="date">
    <div class="past">Feb. 01, 2017</div> Feb. 25, 2017
  </div>
</div>

<div class="unit unit-s-1 unit-m-3-4 unit-l-3-4">
  <div class="unit-spacer">
    <div class="past past-text">Camera Ready Submission Deadline</div> 
    Final version of Extended Abstract or Full Paper Submission Deadline
  </div>
</div>
</div>
