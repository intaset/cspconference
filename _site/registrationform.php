<?php
$my_email = "registration@cspconference.org";
$errors = array();
...
Thank you for registering for CSP 2017. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@cspconference.org. You can find the copyright form here: www.cspconference.org/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@cspconference.org mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for CSP'17";

$your_headers = "From: CSP'17 <" . $my_email . ">";
...
<title>CSP'17 - Registration Form Filled!</title>
...
<p class="body" style="text-align:center!important;">CSP'17 is part of the <b>2<sup>nd</sup> World Congress on Momentum, Heat and Mass Transfer (MHMT'17)</b>. For more information about the congress, please visit the website here: <a href="http://mhmtcongress.com/" class="body-link">www.mhmtcongress.com</a>.</p>
        </div>
    </div>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">CSP'17 is part of the <b>2<sup>nd</sup> World Congress on Momentum, Heat and Mass Transfer (MHMT'17)</b>.<br>For more information about the congress, please visit the website here: <a href="http://mhmtcongress.com/" class="body-link">www.mhmtcongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">CSP 2017 will  be held in Barcelona, Spain on April 6 - 8, 2017 at the Alimara Hotel Barcelona.</p>
  ...
  <div>
      ...
      <p class="body">CSP attracts a wide range of researchers in the field of combustion science and processes. As a prominent company in the field of combustion science and processes, we would like to offer you an exhibit at CSP. Please visit <a href="../events" class="body-link">Events</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at CSP'17!</p>
  </div>
</div>
...
<div class="unit unit-s-1 unit-m-1-4 unit-l-1-4">
  <div class="date">
    <div class="past">Oct. 05, 2016</div> Dec. 08, 2016
  </div>
</div>

<div class="unit unit-s-1 unit-m-3-4 unit-l-3-4">
  <div class="unit-spacer">
    <div class="past past-text">Paper Submission Deadline</div> Extended Paper Submission Deadline
  </div>
</div>
</div>
...
<div class="unit unit-s-1 unit-m-1-4 unit-l-1-4">
  <div class="date">
    <div class="past">Dec. 10, 2016</div> Jan. 20, 2017
  </div>
</div>

<div class="unit unit-s-1 unit-m-3-4 unit-l-3-4">
  <div class="unit-spacer">
    <div class="past past-text">Notification of Authors</div> Extended Notification of Authors
  </div>
</div>
</div>
...
<div class="unit unit-s-1 unit-m-3-4 unit-l-3-4">
  <div class="unit-spacer">
    <div class="past past-text">Final Version of Extended Abstract or Paper Submission Deadline</div> Extended Final Version of Extended Abstract or Paper Submission Deadline
  </div>
</div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
    ...
    +1-613-695-3040<br>
    <a href="mailto:info@cspconference.org">info@cspconference.org</a></p>
    </div>
  </div>

  <div class="unit unit-s-1 unit-m-2-3 unit-l-2-3 contact">
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding CSP'17, please fill out the form below:</p>
