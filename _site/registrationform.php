...
To reserve a room with a DISCOUNTED price, please fill out the provided booking form here: www.cspconference.org/accommodation/#Novotel
...
<p class="body" style="text-align:center!important;">CSP'18 is part of the <b>3<sup>rd</sup> World Congress on Momentum, Heat and Mass Transfer (MHMT'18)</b>. For more information about the congress, please visit the website here: <a href="http://mhmtcongress.com/" class="body-link">www.mhmtcongress.com</a>.</p>
        </div>
    </div>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">CSP'18 is part of the <b>3<sup>rd</sup> World Congress on Momentum, Heat and Mass Transfer (MHMT'18)</b>.<br>For more information about the congress, please visit the website here: <a href="http://mhmtcongress.com/" class="body-link">www.mhmtcongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">CSP 2018:</p>
      <p class="body">CSP 2018 will  be held in Budapest, Hungary on April 12 - 14, 2018 at the Novotel Budapest Centrum.</p>
  ...
  <div>
      ...
      <p class="body">CSP attracts a wide range of researchers in the field of combustion science and processes. As a prominent company in the field of combustion science and processes, we would like to offer you an exhibit at CSP. Please visit <a href="../sponsor" class="body-link">Sponsors</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
...
<footer id="contact">
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6Lce9g0TAAAAAPdWAGPlpxnrpmuOHK3S-voSri5g"></div></center>
  <div class="cf">
